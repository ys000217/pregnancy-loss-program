...
└── analyses/
    ...
    ├── burden/               # SNV/SV mutation burden and genome-wide SV locus enrichment
...
| **SNV/SV burden** | [`analyses/burden/`](analyses/burden/) | Unbiased SNV mut/Mb, SV/P-LP burden, genome-wide PASS SV locus enrichment (strict abnormal-specific = 0) |
...
## SNV/SV burden module

See [`analyses/burden/README.md`](analyses/burden/README.md)
